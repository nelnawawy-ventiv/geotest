define(["https://api.mapbox.com/mapbox-gl-js/v2.15.0/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v5.0.0/mapbox-gl-geocoder.min.js", "https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7h.css"/*, "https://cdn.jsdelivr.net/npm/chart.js@3.9.1/dist/chart.min.js"*/], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    "use strict";
    var map = '',
        bounds = '',
        geojsonFeature = {};
    ...
    BasicControl.prototype.initialize = function (oControlHost, fnDoneInitializing, oDataStore) {
        ...
        document.getElementById("v54_ValueComboBox").addEventListener("change", myFunctionACHUR);

        function myFunctionACHUR() {
        ...
        document.getElementById("v101_ValueComboBox").addEventListener("change", myFunction6);
        ...
        document.getElementById("v113_ValueComboBox").addEventListener("change", myFunction7);
        ...
        document.getElementById("v125_ValueComboBox").addEventListener("change", myFunction8);
        ...
        document.getElementById("v137_ValueComboBox").addEventListener("change", sealevelfunction);
        ...
        document.getElementById("v149_ValueComboBox").addEventListener("change", myFunctionUSWA);

        function myFunctionUSWA() {

            var visibility = map.getLayoutProperty('Global Satellite (GOES)', 'visibility');

            if (visibility === 'visible') {
                map.setLayoutProperty('Global Satellite (GOES)', 'visibility', 'none');
                //document.getElementById("v138_ValueComboBox").style.backgroundColor = '#9BA3A5';

            } else {

                map.setLayoutProperty('Global Satellite (GOES)', 'visibility', 'visible');
                //document.getElementById("v138_ValueComboBox").style.backgroundColor = '#EFE013';
            }

        }

        document.getElementById("v160_ValueComboBox").addEventListener("change", myFunctionUSFL);
        ...
        document.getElementById("v204_ValueComboBox").addEventListener("change", myFunctionWSA);

        function myFunctionWSA() {

            var visibility = map.getLayoutProperty('AUS Wet Surface Area', 'visibility');

            if (visibility === 'visible') {
                map.setLayoutProperty('AUS Wet Surface Area', 'visibility', 'none');
                //document.getElementById("v138_ValueComboBox").style.backgroundColor = '#9BA3A5';

            } else {

                map.setLayoutProperty('AUS Wet Surface Area', 'visibility', 'visible');
                //document.getElementById("v138_ValueComboBox").style.backgroundColor = '#EFE013';
            }

        }

        document.getElementById("v215_ValueComboBox").addEventListener("change", myFunctionVOL);
        ...
        document.getElementById("v226_ValueComboBox").addEventListener("change", myFunctionTSUNAMI);
        ...
        document.getElementById("v237_ValueComboBox").addEventListener("change", myFunctionRadar);

        function myFunctionRadar() {
        ...
        document.getElementById("v248_ValueComboBox").addEventListener("change", myFunctionGLTemps);

        function myFunctionGLTemps() {

            var visibility = map.getLayoutProperty('Global Temps', 'visibility');

            if (visibility === 'visible') {
                map.setLayoutProperty('Global Temps', 'visibility', 'none');
                //document.getElementById("v138_ValueComboBox").style.backgroundColor = '#9BA3A5';

            } else {

                map.setLayoutProperty('Global Temps', 'visibility', 'visible');
                //document.getElementById("v138_ValueComboBox").style.backgroundColor = '#EFE013';
            }

        }

        jQuery("head link[rel='stylesheet']").last().after("<link href='https://api.mapbox.com/mapbox-gl-js/v2.15.0/mapbox-gl.css' rel='stylesheet' />");
        ...
        map = new mapboxgl.Map({
            ...
            center: [144.9316, -29.2289], //Center Map
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('click', 'Active Hurricanes - Tracks', function (e) {
            var Day = new Date(e.features[0].properties.ADVDATE);
            var Day1 = Day.toUTCString();
        ...
        map.on('load', function () {
            ...
            map.addSource('galswbv2GR4000-76e5zq', {
                type: 'vector',
                url: 'mapbox://nevnd.97410erv' //fxhawk.b7tr8njd'
            });
            map.addLayer({
                "id": "AUS Wet Surface Area",
                "type": "fill",
                "source": "galswbv2GR4000-76e5zq",
                "source-layer": "galswbv2GR4000-76e5zq",
                "layout": {
                    "visibility": auswetsurface
                },
                "paint": {
                    "fill-color": "#18c1de",
                    "fill-opacity": 0.6
        ...
        map.on('load', function () {
            map.addSource('aerisweather-layers', {
                type: 'raster',
                tiles: [
                    'https://maps1.aerisapi.com/mA09d6UbckvIzJgLCWzs7_CYzzAPNCnZpW0NWFictnXWspQJkzAhi9XIRH6D6D/radar-global/{z}/{x}/{y}/current.png',
                    'https://maps2.aerisapi.com/mA09d6UbckvIzJgLCWzs7_CYzzAPNCnZpW0NWFictnXWspQJkzAhi9XIRH6D6D/radar-global/{z}/{x}/{y}/current.png',
                    'https://maps3.aerisapi.com/mA09d6UbckvIzJgLCWzs7_CYzzAPNCnZpW0NWFictnXWspQJkzAhi9XIRH6D6D/radar-global/{z}/{x}/{y}/current.png',
                    'https://maps4.aerisapi.com/mA09d6UbckvIzJgLCWzs7_CYzzAPNCnZpW0NWFictnXWspQJkzAhi9XIRH6D6D/radar-global/{z}/{x}/{y}/current.png'
                ],
                tileSize: 256,
                attribution: '<a href="https://www.aerisweather.com/">AerisWeather</a>'
            });
        ...
        map.on('load', () => {
            map.addSource('aeristemps', {
                type: 'raster',
                tiles: [
                    'https://maps1.aerisapi.com/mA09d6UbckvIzJgLCWzs7_CYzzAPNCnZpW0NWFictnXWspQJkzAhi9XIRH6D6D/temperatures,temperatures-text-metric/{z}/{x}/{y}/current.png',
                    'https://maps2.aerisapi.com/mA09d6UbckvIzJgLCWzs7_CYzzAPNCnZpW0NWFictnXWspQJkzAhi9XIRH6D6D/temperatures,temperatures-text-metric/{z}/{x}/{y}/current.png',
                    'https://maps3.aerisapi.com/mA09d6UbckvIzJgLCWzs7_CYzzAPNCnZpW0NWFictnXWspQJkzAhi9XIRH6D6D/temperatures,temperatures-text-metric/{z}/{x}/{y}/current.png',
                    'https://maps4.aerisapi.com/mA09d6UbckvIzJgLCWzs7_CYzzAPNCnZpW0NWFictnXWspQJkzAhi9XIRH6D6D/temperatures,temperatures-text-metric/{z}/{x}/{y}/current.png'
                ],
                tileSize: 256,
                attribution: '<a href="https://www.aerisweather.com/">AerisWeather</a>'
            });
        ...
        map.on('click', function (e) {
            ...
            var popup = new mapboxgl.Popup({ offset: [0, -15] })
                .setLngLat(feature.geometry.coordinates)
                .setHTML('<h3>' + feature.properties.Office + '</h3>' + 'Street: ' + feature.properties.Street + '<br>' + 'Insured Value: ' + propvalue.toLocaleString('en-US', {
                    style: 'currency',
                    currency: 'USD',
                }) + '</p>')
                .setLngLat(feature.geometry.coordinates)
    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            feature['properties'] = { 'name': oDataStore.getCellValue(iRow, 0), 'total_paid3': oDataStore.getCellValue(iRow, 27), 'Net_Incurred_Total': oDataStore.getCellValue(iRow, 28) }
            ...
            civilunrest = oDataStore.getCellValue(iRow, 16)
            MODIS = oDataStore.getCellValue(iRow, 17)
            emergencyVIC = oDataStore.getCellValue(iRow, 18)
            Business_Unit = oDataStore.getCellValue(iRow, 19)
            Coverage = oDataStore.getCellValue(iRow, 20)
            auswetsurface = oDataStore.getCellValue(iRow, 21)
            volcanerup = oDataStore.getCellValue(iRow, 22)
            activehur = oDataStore.getCellValue(iRow, 23)
            tsunami = oDataStore.getCellValue(iRow, 24)
            globalradar = oDataStore.getCellValue(iRow, 25)
            globaltemp = oDataStore.getCellValue(iRow, 26)
