        ...
        map.on('load', function () {
            map.addLayer({
                ...
                "source": {
                    "type": "raster",
                    "tiles": [
                        'https://www.asris.csiro.au/arcgis/rest/services/abares/clum_50m_current/MapServer/export?bbox=1.1922874421423633E7%2C-3537904.8812746527%2C1.776842996502382E7%2C-569099.1130682579&bboxSR=&layers=show%3A0&layerDefs=&size=&imageSR=&format=png&transparent=true&dpi=96&time=&layerTimeOptions=&dynamicLayers=&gdbVersion=&mapScale=&rotation=&datumTransformations=&layerParameterValues=&mapRangeValues=&layerRangeValues=&f=image'
                    ],
                    "tilesize": 256
                    ///"type": "geojson",
