        ...
        map.on('load', function () {
            map.addLayer({
                ...
                "source": {
                    "type": "raster",
                    "tiles": [
                        'https://services.ga.gov.au/gis/rest/services/NEXIS_Residential_Dwelling_Density/MapServer/export?dpi=96&transparent=true&format=png32&layers=show%3A3&bbox={bbox-epsg-3857}&bboxSR=EPSG:3857&imageSR=EPSG:3857&size=256,256&f=image' //export?bbox=-3850823.969990419%2C-5369043.910844071%2C3041740.5461386135%2C-694146.6273126616&bboxSR=&layers=show%3A3&layerDefs=&size=&imageSR=&historicMoment=&format=png&transparent=true&dpi=&time=&timeRelation=esriTimeRelationOverlaps&layerTimeOptions=&dynamicLayers=&gdbVersion=&mapScale=&rotation=&datumTransformations=&layerParameterValues=&mapRangeValues=&layerRangeValues=&clipping=&spatialFilter=&f=image'
