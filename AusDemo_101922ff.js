    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        map.on('click', 'points', function (e) {
            ...
            new mapboxgl.Popup()
                ...
                .setHTML('<h3>' + 'Claim: ' + Claim_N + '</h3>' + '<br>' + 'Loss Date: ' + e.features[0].properties.Loss_Date.toUTCString() + '<br>' + 'Total Net Incurred: ' + e.features[0].properties.Net_Incurred_Total + '<br>' + 'Organisation: ' + e.features[0].properties.Business_Unit + '<br>' + 'Coverage: ' + e.features[0].properties.Coverage + '<br>' + 'Paid: ' + Paid.toLocaleString('en-US', {
                    style: 'currency',
                    currency: 'USD',
