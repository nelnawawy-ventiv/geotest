define(["https://api.mapbox.com/mapbox-gl-js/v2.11.0/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v5.0.0/mapbox-gl-geocoder.min.js", "https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7h.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    ...
    BasicControl.prototype.initialize = function (oControlHost, fnDoneInitializing, oDataStore) {
        ...
        function myFunction3() {
            ...
            var visibility = map.getLayoutProperty('Shipping Routes', 'visibility');

            if (visibility === 'visible') {
                map.setLayoutProperty('Shipping Routes', 'visibility', 'none');
                //document.getElementById("v54_ValueComboBox").style.backgroundColor = '#9BA3A5';

            } else {

                map.setLayoutProperty('Shipping Routes', 'visibility', 'visible');
                //document.getElementById("v54_ValueComboBox").style.backgroundColor = '#EFE013';
            }

        }

        document.getElementById("v65_ValueComboBox").addEventListener("change", myFunctionSHIPS);

        function myFunctionSHIPS() {

            var visibility = map.getLayoutProperty('Ships', 'visibility');
        ...
        document.getElementById("v77_ValueComboBox").addEventListener("change", myFunction4);
        ...
        document.getElementById("v137_ValueComboBox").addEventListener("change", myFunction9);
        ...
        document.getElementById("v149_ValueComboBox").addEventListener("change", tornadoes24);
        ...
        document.getElementById("v161_ValueComboBox").addEventListener("change", myFunction10);
        ...
        document.getElementById("v173_ValueComboBox").addEventListener("change", myFunctionUSWA);
        ...
        document.getElementById("v184_ValueComboBox").addEventListener("change", myFunctionUSFL);
        ...
        document.getElementById("v228_ValueComboBox").addEventListener("change", myFunctionTSUNAMI);
        ...
        document.getElementById("v239_ValueComboBox").addEventListener("change", myFunCtionGLRADAR);
        ...
        document.getElementById("v250_ValueComboBox").addEventListener("change", myFunctionGLTemps);
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on("load", function () {
            map.addSource("CargoClaims", {
                "type": "vector",
                url: "mapbox://nevnd.clf2b98hw04r02bpfugjq3bao-2g57n"
            });
        ...
        map.on('load', function () {
            ...
            map.addSource('Shipping-Lanes-v1-2h4fab', {
                type: 'vector',
                url: 'mapbox://nevnd.7xfs05t7' //fxhawk.cjhhzt5rk00hw2xro80s4lgdy-8ybmv'
            });
            map.addLayer({
                'id': 'Shipping Routes',
                "type": "line",
                "source": "Shipping-Lanes-v1-2h4fab",
                "source-layer": "Shipping-Lanes-v1-2h4fab",
                "layout": {
                    "visibility": radar
                },
                "paint": {
        ...
        map.on('load', () => {
            ...
            map.addSource('ShipSIM-a1rekv', {
                'type': 'vector',
                url: "mapbox://nevnd.aso2o4b5",
            });
            ...
            map.addLayer({
                'id': 'Ships',
                'type': 'circle',
                'source': 'ShipSIM-a1rekv',
                'source-layer': 'ShipSIM-a1rekv',
                'layout': {
                    'visibility': radar,
                    //'icon-image': 'custom-marker',
                    // get the title name from the source's "title" propert
                },
                "paint": {
                    "circle-radius": 2,
                    "circle-color": "#6A46CC",
        ...
        map.on('click', 'Ships', function (e) {
            
            new mapboxgl.Popup()
                .setLngLat(e.lngLat)
                .setHTML('<h3>' + 'Ship No: ' + e.features[0].properties.SHIPNO + '</h3><p>' + 'Port: ' + e.features[0].properties.PORT + '<br>' + 'HIN: ' + e.features[0].properties.HIN + '</p>')
                .addTo(map);
        });
        ...
        map.on('load', function () {
            map.addSource('CarrierLoc', {
                type: 'vector',
                url: 'mapbox://nevnd.clf2b3zlw0c3m2bpazsv6qb0v-0fogh'//'mapbox://fxhawk.cjhkjvk4202mi6mt2y4lkns44-7mdr6'
            });
            map.addLayer({
                'id': 'Properties2',
                'type': 'circle',
                'source': 'CarrierLoc',
                'source-layer': 'CarrierLoc',
                "layout": {
                    "visibility": property//,
                    /*"text-field": [
                        "format",
        ...
        map.on('draw.create', function (e) {
            ...
            var features = map.queryRenderedFeatures([southWestPointPixel, northEastPointPixel], { layers: ['Claims'] });
            ...
            window.aggr = features.reduce(function (memo, feature, Paid3) {
                ...
                if (!(undefined === turf.intersect(feature, userPolygon))) {
                    ...
                    var Paid3 = feature.properties.Total_Paid;
    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        map.on('click', 'Claims', function (e) {
            var coordinates = e.features[0].geometry.coordinates.slice();
            var Paid = e.features[0].properties.Total_Paid;
            ...
            new mapboxgl.Popup()
                ...
                .setHTML('<h3>' + 'Claim: ' + Claim_N + '</h3>' + /*'Street: ' + Street_N + '<br>' + 'City: ' + City_N + '<br>' + */'Paid: ' + Paid/* + 'Claims TYTD: ' + total_claims*/ + '</p>')//+ 'Total Insured: $ ' + paidf + '<br>' + 'Claims TYTD: ' + total_claims + '</p>')
                .addTo(map);
        });
