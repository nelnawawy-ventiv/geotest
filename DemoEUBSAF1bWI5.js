    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('load', function () {
            map.addLayer({
                ...
                "source": {
                    "type": "raster",
                    "tiles": ['https://gis1.servirglobal.net/arcgis/rest/services/Global/MODIS_Fire_1DAY/MapServer/export?bbox=-238.88890599796747%2C9.422347384996819%2C242.92900609562372%2C136.58002570311996&bboxSR=EPSG%3A3857&layers=&layerDefs=&size=&imageSR=EPSG%3A3857&format=png&transparent=true&dpi=&time=&layerTimeOptions=&dynamicLayers=&gdbVersion=&mapScale=&rotation=&f=image'],
