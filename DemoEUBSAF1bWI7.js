    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('load', function () {
            map.addLayer({
                ...
                "source": {
                    "type": "raster",
                    "tiles": ['https://firms.modaps.eosdis.nasa.gov/mapserver/wms/fires/de5657f1c6c0c8d26e629bbefbaeeceb/?REQUEST=GetMap&layers=fires_modis_24,fires_viirs_24&WIDTH=1024&HEIGHT=512&BBOX=-180,-90,180,90&symbols=triangle,triangle&colors=240+40+40,250+200+50&size=5,2&version=1.1.1'],
