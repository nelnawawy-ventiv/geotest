    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('load', function () {
            map.addLayer({
                ...
                "source": {
                    "type": "geojson",
                    "data": ['https://firms2.modaps.eosdis.nasa.gov/mapserver/wfs/Europe/YourMapKey/?SERVICE=WFS&REQUEST=GetFeature&VERSION=2.0.0&TYPENAME=ms:fires_modis_24hrs&STARTINDEX=0&COUNT=1000&SRSNAME=urn:ogc:def:crs:EPSG::3857&BBOX=-90,-180,90,180,urn:ogc:def:crs:EPSG::4326&outputformat=geojson']
