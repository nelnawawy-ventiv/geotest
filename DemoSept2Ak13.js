define(["https://api.mapbox.com/mapbox-gl-js/v2.4.1/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v4.7.0/mapbox-gl-geocoder.min.js", "https://unpkg.com/@turf/turf@6/turf.min.js"/*"https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js"*/, "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.2.2/mapbox-gl-draw.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7c.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    "use strict";
    var map = '',
        bounds = '',
        geojsonFeature = {};
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        jQuery('body .mapboxgl-control-container').append('<div id=' + 'main-legend' + ' ' + 'class=' + 'legend' + '>' + '<h4>' + 'Legend' + '</h4>' + '<div>' + '<span style=' + '"background-image:' + " url('https://cdn.rawgit.com/mapbox/mapbox-gl-styles/master/sprites/bright-v9/_svg/town-hall-11.svg')" + '; padding: 10px 10px 5px 10px; left: auto; margin: auto auto auto -2px;">' + '</span>' + 'Properties' + '</div>' + '<div>' + '<span style=' + '"background-color: #efbf13"' + '>' + '</span>' + 'Claims' + '</div>' + '<div>' + '<span style=' + '"background-color: #f80a0a"' + '>' + '</span>' + 'Wildfire' + '</div>' + '<div>' + 'Flooding' + '<div>' + '<span style=' + '"background-image:' + " url('https://cdn.rawgit.com/mapbox/mapbox-gl-styles/master/sprites/bright-v9/_svg/castle-11.svg')" + '; padding: 10px 10px 5px 10px; left: auto; margin: auto auto auto -2px;">' + '</span>' + 'Defended Areas' + '</div>' + '<div>' + '<span style=' + /*'"background: linear-gradient( to right, #2d97fb, #8404a4 )'*/'"background-color: #40b1f2"' + '; width: 15px;"' + '>' + '</span>' + '30m 20-year' + '</div>' + '<div>' + '<span style=' + '"background-image:' + " url('https://www.google.com/search?q=dot+with+outline+svg&rlz=1C1VDKB_enUS946US946&hl=en-US&source=lnms&tbm=isch&sa=X&ved=2ahUKEwj4jtCa1oLzAhWIRjABHf-_BUwQ_AUoAXoECAEQAw&biw=1536&bih=696&dpr=1.25#imgrc=7gvXVVLYclYY0M')" + '; padding: 10px 10px 5px 10px; left: auto; margin: auto auto auto -2px;">' + '</span>' + 'Civil Unrest Event' + '</div>' + '</div>');
        ...
        */
        ...
        map.on('click', 'Political Unrest', function (e) {
            var Day = new Date(e.features[0].properties.date_start);
            var Day1 = Day.toUTCString();

            new mapboxgl.Popup()
                .setLngLat(e.lngLat)
                .setHTML('<h3>' + 'Event Source: ' + e.features[0].properties.source_article + '</h3><p>' + 'Date: ' + Day1 + '<br>' + 'Headline: ' + e.features[0].properties.source_headline + '<br>' + 'Deaths:' + e.features[0].properties.deaths_a + '<br>' + 'Location: ' + e.features[0].properties.where_description + '</p>')
                .addTo(map);
        });

        // Change the cursor to a pointer when the mouse is over the states layer.
        map.on('mouseenter', 'Political Unrest', function () {
            map.getCanvas().style.cursor = 'pointer';
        });

        // Change it back to a pointer when it leaves.
        map.on('mouseleave', 'Political Unrest', function () {
            map.getCanvas().style.cursor = '';
        });
        ...
        map.on('click', 'Political Unrest - USA & Europe', function (e) {
            var Day = new Date(e.features[0].properties.Date);
            var Day1 = Day.toUTCString();

            new mapboxgl.Popup()
                .setLngLat(e.lngLat)
                .setHTML('<h3>' + 'Actor Type: ' + e.features[0].properties.Actor1Type + '</h3><p>' + 'Date: ' + Day1 + '<br>' + 'Source: ' + e.features[0].properties.Source + '<br>' + /*'Deaths:' + e.features[0].properties.deaths_a + '<br>' + */'Location: ' + e.features[0].properties.Column53 + '</p>')
                .addTo(map);
        });

        // Change the cursor to a pointer when the mouse is over the states layer.
        map.on('mouseenter', 'Political Unrest - USA & Europe', function () {
            map.getCanvas().style.cursor = 'pointer';
        });

        // Change it back to a pointer when it leaves.
        map.on('mouseleave', 'Political Unrest - USA & Europe', function () {
            map.getCanvas().style.cursor = '';
        });
