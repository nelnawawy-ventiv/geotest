    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('load', function () {
            ...
            map.addSource('GEDEvent_v22_07to08', {
                type: 'vector',
                url: 'nevnd.cl97byrqp0vn321od1y6gxusf-67fws' //nevnd.ckr0tdn0u4rov20to1aq9z17x-5p275' //fxhawk.cjhhzt5rk00hw2xro80s4lgdy-8ybmv'
            });
            map.addLayer({
        ...
        map.on('click', 'Global Civil Unrest', function (e) {
            ...
            var popup = new mapboxgl.Popup({ offset: [0, -15] })
                .setLngLat(e.lngLat)
                //.setLngLat(feature.geometry.coordinates[0])
                .setHTML('<h3>' + feature.properties.conflict_name + '</h3><p>' + 'Country: ' + feature.properties.country + '<br>' + 'Source Date: ' + feature.properties.source_date + '<br>' + ' Headline: ' + feature.properties.source_headline + '<br>' + ' Sources: ' + feature.properties.source_office + '<br>' + ' Civilian Deaths: ' + feature.properties.deaths_civilians + '</p>')
