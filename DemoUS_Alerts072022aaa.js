    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('click', 'US Weather Alerts', function (e) {
            ...
            var popup = new mapboxgl.Popup({ offset: [0, -15] })
                ...
                .setHTML('<h3>' + feature.properties.headline + '</h3><p>' + '<br>' + 'Event Type: ' + feature.properties.event + '<br>' + 'Effective: ' + feature.properties.effective + '<br>' + 'Expires: ' + feature.properties.expires + '<br>' + ' Severity: ' + feature.properties.severity + '<br>' + ' Status: ' + feature.properties.status + '<br>' + ' Description: ' + feature.properties.description + '</p>')
