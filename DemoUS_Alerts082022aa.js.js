define(["https://api.mapbox.com/mapbox-gl-js/v2.9.2/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v5.0.0/mapbox-gl-geocoder.min.js", "https://unpkg.com/@turf/turf@6/turf.min.js"/*"https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js"*/, "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    "use strict";
    var map = '',
        bounds = '',
        geojsonFeature = {};
    ...
    BasicControl.prototype.initialize = function (oControlHost, fnDoneInitializing, oDataStore) {
        ...
        document.getElementById("v78_ValueComboBox").addEventListener("change", myFunction);
        ...
        document.getElementById("v89_ValueComboBox").addEventListener("change", myFunction2);
        ...
        document.getElementById("v32_ValueComboBox").addEventListener("change", myFunction3);

        function myFunction3() {

            var visibility = map.getLayoutProperty('Global Earthquake Alerts', 'visibility');

            if (visibility === 'visible') {
                map.setLayoutProperty('Global Earthquake Alerts', 'visibility', 'none');
                //document.getElementById("v54_ValueComboBox").style.backgroundColor = '#9BA3A5';

            } else {

                map.setLayoutProperty('Global Earthquake Alerts', 'visibility', 'visible');
                //document.getElementById("v54_ValueComboBox").style.backgroundColor = '#EFE013';
            }

        }
        document.getElementById("v44_ValueComboBox").addEventListener("change", myFunction4);

        function myFunction4() {

            var visibility = map.getLayoutProperty('US Wildfire Alerts', 'visibility');

            if (visibility === 'visible') {
                map.setLayoutProperty('US Wildfire Alerts', 'visibility', 'none');
                //document.getElementById("v66_ValueComboBox").style.backgroundColor = '#9BA3A5';

            } else {

                map.setLayoutProperty('US Wildfire Alerts', 'visibility', 'visible');
                //document.getElementById("v66_ValueComboBox").style.backgroundColor = '#EFE013';
            }

        }

        document.getElementById("v55_ValueComboBox").addEventListener("change", myFunction5);

        function myFunction5() {

            var visibility = map.getLayoutProperty('Global Fire Activity Alerts', 'visibility');

            if (visibility === 'visible') {
                map.setLayoutProperty('Global Fire Activity Alerts', 'visibility', 'none');
                //document.getElementById("v78_ValueComboBox").style.backgroundColor = '#9BA3A5';

            } else {

                map.setLayoutProperty('Global Fire Activity Alerts', 'visibility', 'visible');
                //document.getElementById("v78_ValueComboBox").style.backgroundColor = '#EFE013';
            }

        }

        document.getElementById("v67_ValueComboBox").addEventListener("change", myFunction6);
        ...
        map = new mapboxgl.Map({
            ...
            center: [-104.07291426984786, 48.88099572154087], //Center Map
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('click', function (e) {
            ...
            var features = map.queryRenderedFeatures(e.point, {
                layers: ['Global Earthquake Alerts'] // replace this with the name of the layer
            });
        ...
        map.on('mouseenter', 'Global Earthquake Alerts', function () {
            map.getCanvas().style.cursor = 'pointer';
        });

        // Change it back to a pointer when it leaves.
        map.on('mouseleave', 'Global Earthquake Alerts', function () {
        ...
        map.on('click', 'US Weather Alerts', function (e) {
            ...
            var popup = new mapboxgl.Popup({ offset: [0, -15] })
                ...
                .setHTML('<h3>' + feature.properties.headline + '</h3><p>' + '<br>' + 'Event Type: ' + feature.properties.event + '<br>' + 'Effective: ' + feature.properties.effective + '<br>' + 'Expires: ' + feature.properties.expires + '<br>' + ' Severity: ' + feature.properties.severity + '<br>' + /*' Description: ' + feature.properties.description + '<br>' + */' Status: ' + feature.properties.status + '</p>')
...
map.getCanvas().style.cursor = 'pointer';
    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            feature['properties'] = { 'name': oDataStore.getCellValue(iRow, 0), 'total_paid3': oDataStore.getCellValue(iRow, 18) }
            ...
            MODIS = oDataStore.getCellValue(iRow, 16)
            usweatheralerts = oDataStore.getCellValue(iRow, 17)
