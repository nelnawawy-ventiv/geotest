        ...
        */
        ...
        map.on('load', function () {
            map.addLayer({
                ...
                "source": {
                    "type": "raster",
                    "tiles": ['https://idpgis.ncep.noaa.gov/arcgis/rest/services/NWS_Forecasts_Guidance_Warnings/NDFD_temp/MapServer/export?bbox=-129.72946923559348,4.0654558126074285,-83.74638529792335,66.47106972801691'],
                    "tileSize": 256
