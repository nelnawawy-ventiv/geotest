define(["https://api.mapbox.com/mapbox-gl-js/v2.3.1/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v2.3.0/mapbox-gl-geocoder.min.js", "https://api.tiles.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.2.1.min.js", "https://code.jquery.com/ui/1.12.1/jquery-ui.min.js", "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase3.css", "https://cdn.jsdelivr.net/npm/mapbox-gl-style-switcher@1.0.10/dist/index.js"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info, MapboxStyleSwitcherControl) {
    ...
    BasicControl.prototype.initialize = function (oControlHost, fnDoneInitializing, oDataStore) {
        ...
        if (!mapboxgl.supported()) {
            ...
            //var layerList = document.getElementById('layer-switcher');
            ///var inputs = layerList.getElementsByTagName('input');

            var inputs = document.getElementById('layer-switcher').getElementsByClassName('input');
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        jQuery('body .mapboxgl-control-container').insertAdjacentHTML('<div id=' + 'layer-switcher' +' class=' + 'menu' + '>' + '<input id=' + '"streets-v11"' + ' type=' + '"radio"' + ' name=' + '"rtoggle"' + ' value=' + '"Streets"' + ' checked=' + '"checked"' + '>' + '<label for=' + '"streets-v11"' + '>' + 'Streets' + '</label>' + '<input id=' + '"light-v10"' + ' type="radio"' + ' name="rtoggle"' + ' value="light"' + '>' + '<label for=' + '"light-v10"' + '>' + 'Light' + '</label>' + '<input id=' + '"dark-v10"' + ' type="radio"' + ' name="rtoggle"' + ' value="dark"' + '>' + '<label for=' + '"dark-v10"' + '>' + 'Dark' + '</label>' + '<input id=' + '"satellite-v9"' + ' type="radio"' + ' name=' + '"rtoggle"' + ' value=' + '"satellite"' + '>' + '<label for=' + '"satellite-v9"' + '>' + 'Satellite' + '</label>' + '<input id=' + '"outdoors-v11"' + ' type=' + '"radio"' + ' name="rtoggle"' + ' value=' + '"outdoors"' + '>' + '<label for=' + '"outdoors-v11"' + '>' + 'Outdoors' + '</label>' + '</div>');
