define(["https://api.mapbox.com/mapbox-gl-js/v2.3.1/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v2.3.0/mapbox-gl-geocoder.min.js", "https://api.tiles.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.2.1.min.js", "https://code.jquery.com/ui/1.12.1/jquery-ui.min.js", "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase4.css", "https://cdn.jsdelivr.net/npm/mapbox-gl-style-switcher@1.0.10/dist/index.js"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info, MapboxStyleSwitcherControl) {
    "use strict";
    var map = '',
        bounds = '',
        geojsonFeature = {};
    ...
    BasicControl.prototype.initialize = function (oControlHost, fnDoneInitializing, oDataStore) {
        ...
        jQuery("body").after("<link rel='stylesheet' href='https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v2.3.0/mapbox-gl-geocoder.css' type='text/css' />");
        ...
        jQuery("tbody").after("<link rel='stylesheet' href='https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase4.css' rel='stylesheet' />");
        jQuery("head link[rel='stylesheet']").last().after("<link href='https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase4.css' type='text/css' />");
        //jQuery("body").prepend("<link rel='stylesheet' href='https://cdn.jsdelivr.net/npm/mapbox-gl-style-switcher@1.0.10/styles.css' type='text/css'/>");
        ...
        if (!mapboxgl.supported()) {
            alert('Your browser does not support Mapbox GL or needs to be updated')
        } else {
            ...
            /*var inputs = document.getElementById('layer-switcher').getElementsByTagName('input');
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        //jQuery('body .mapboxgl-style-menu').append('<div id=' + 'menu' + ' ' + 'class=' + 'style-menu' + '>' + '<' + 'input id' + ' = ' + '"streets-v11"' + ' type = "radio"' + ' name = ' + '"rtoggle"' + ' value = ' + '"Streets"' + ' checked = ' + '"checked"' + '<label for=' + '"satellite-v9"' + '>' + 'satellite' + '</label>' + '<input id=' + '"light-v10"' + ' type=' + '"radio"' + ' name=' + '"rtoggle"' + ' value=' + '"light"' +'>' + '<' + ' label for=' + ' "light-v10"' + ' > ' + 'light' + '</label >' + '<input id=' + '"dark-v10"' + ' type=' + '"radio"' + ' name=' + '"rtoggle"' + ' value=' + '"dark"' + '>' +  '<' + 'label for=' + '"dark-v10"' '>dark</label>
        //var stylesswitch = '<div class="menu" id="menu">< input id = "streets-v11" type = "radio" name = "rtoggle" value = "Streets" checked = "checked" ><label for="streets-v11">Streets</label><input id="light-v10" type="radio" name="rtoggle" value="light"><label for="light-v10">Light</label><input id="dark-v10" type="radio" name="rtoggle" value="dark"><label for="dark-v10">Dark</label><input id="satellite-v9" type="radio" name="rtoggle" value="satellite"><label for="satellite-v9">Satellite</label><input id="outdoors-v11" type="radio" name="rtoggle" value="outdoors"><label for="outdoors-v11">Outdoors</label></div>';
        //jQuery('body .mapboxgl-control-container').append('<div id=' + 'layer-switcher' +' class=' + 'menu' + '>' + '<input id=' + '"streets-v11"' + ' type=' + '"radio"' + ' name=' + '"rtoggle"' + ' value=' + '"Streets"' + ' checked=' + '"checked"' + '>' + '<label for=' + '"streets-v11"' + '>' + 'Streets' + '</label>' + '<input id=' + '"light-v10"' + ' type=' +'radio' + ' name=' + 'rtoggle' + 'value=' + 'light' + '>' + '<label for=' + 'light-v10' + '>' + 'Light' + '</label>' + '<input id=' + '"dark-v10"' + ' type=' + 'radio' + ' name=' + 'rtoggle' + ' value=' + 'dark' + '>' + '<label for=' + '"dark-v10"' + '>' + 'Dark' + '</label>' + '<input id=' + '"satellite-v9"' + ' type=' + 'radio' + ' name=' + 'rtoggle' + ' value=' + 'satellite' + '>' + '<label for=' + '"satellite-v9"' + '>' + 'Satellite' + '</label>' + '<input id=' + '"outdoors-v11"' + ' type=' + 'radio' + ' name=' + 'rtoggle' + ' value=' + 'outdoors' + '>' + '<label for=' + '"outdoors-v11"' + '>' + 'Outdoors' + '</label>' + '</div>');
        ...
        //jQuery('body .mapboxgl-control-container').append('<div id=' + 'layer-switcher' + ' ' + 'class=' + 'menu' + '>' + '<input id=' + '"streets-v11"' + ' type=' + '"radio"' + ' name=' + '"rtoggle"' + ' value=' + '"streets"' + ' checked=' + '"checked"' + '>' + '<label for=' + '"streets-v11"' + '>' + 'Streets' + '</label>' + '<br>' + '<input id=' + '"light-v10"' + ' type=' + '"radio"' + ' name=' + '"rtoggle"' + ' value=' + '"light"' + '>' + '<label for=' + '"light-v10"' + '>' + 'Light' + '</label>' + '<br>' + '</div>');
        ...
        //reset style layout
        map.on('styledataloading' | 'styledata', function () {
            draw.trash();
