    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('load', function () {
            ...
            function afterChangeComplete(e) {
                ...
                map.queryRenderedFeatures(e.point, {layers: ['Properties2']});
                map.off('render', afterChangeComplete);
            }
        })
