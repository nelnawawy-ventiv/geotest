define(["https://api.mapbox.com/mapbox-gl-js/v2.3.1/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v4.7.0/mapbox-gl-geocoder.min.js", "https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js", "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase5.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, slider1, slider2, Info) {
    "use strict";
    var map = '',
        bounds = '',
        geojsonFeature = {};
