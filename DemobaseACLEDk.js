define(["https://api.mapbox.com/mapbox-gl-js/v2.3.1/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v4.7.0/mapbox-gl-geocoder.min.js", "https://unpkg.com/@turf/turf@6/turf.min.js"/*"https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js"*/, "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    ...
    BasicControl.prototype.initialize = function (oControlHost, fnDoneInitializing, oDataStore) {
        ...
        document.getElementById("v162_ValueComboBox").addEventListener("change", myFunctionPolitical);
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        */
        ...
        map.on('load', function () {
            ...
            map.addSource('06210721PU', { //'CASTSU1500B-9alk2o', {
                type: 'vector',
                url: 'mapbox://nevnd.ckr0tdn0u4rov20to1aq9z17x-5p275', //'mapbox://nevnd.dm23d4er',
                //tileSize: 256
            });
            map.addLayer({
                "id": "Political",
                "type": "circle",
                "source": "06210721PU", //"CASTSU1500B-9alk2o",
                "source-layer": "06210721PU",//"CASTSU1500B-9alk2o",
                //"minzoom": 12,
                //"maxzoom": 22,
                "layout": {
                ...
                "filter": [["!=", "Protests", "Political"], ["!=", "Strategic developments", "Political"]],
                firstSymbolId
            });
        })
    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            political_ur = oDataStore.getCellValue(iRow, 16)
