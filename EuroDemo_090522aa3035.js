    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('load', function () {
            map.addLayer({
                ...
                "source": {
                    "type": "raster",
                    "tiles": ['https://climate.discomap.eea.europa.eu/arcgis/rest/services/Urban_Vulnerability/Temperatures_Change_max/MapServer/export?dpi=96&transparent=true&format=png32&layers=show%3A0&bbox={bbox-epsg-3035}&bboxSR=EPSG:3035&imageSR=EPSG:3035&size=256,256&f=image'], //'https://climate.discomap.eea.europa.eu/arcgis/rest/services/Urban_Vulnerability/Temperatures_Change_max/MapServer/export?dpi=96&transparent=true&format=png32&layers=show%3A0&bbox={bbox-epsg-3857}&bboxSR=EPSG:3857&imageSR=EPSG:3857&size=256,256&f=image'], //3035
                    "tileSize": 256
