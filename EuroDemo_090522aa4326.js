    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('load', function () {
            map.addLayer({
                ...
                "source": {
                    "type": "raster",
                    "tiles": ['https://climate.discomap.eea.europa.eu/arcgis/rest/services/Urban_Vulnerability/Temperatures_Change_max/MapServer/export?dpi=96&transparent=true&format=png32&layers=show%3A0&bbox={bbox-epsg-4326}&bboxSR=EPSG:4326&imageSR=EPSG:4326&size=256,256&f=image'], //3035
                    "tileSize": 256
