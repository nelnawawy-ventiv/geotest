    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('load', function () {
            ...
            map.addSource('ws3028cl-36haid', {
                type: 'vector',
                url: 'mapbox://nevnd.nevnd.5e6l64gw' //fxhawk.b7tr8njd'
            });
            map.addLayer({
                ...
                "paint": {
                    ...
                    "fill-color": {
                        ...
                        "base": 3, //1.8,
                        "stops": [
                            ["2.8x or greater decrease","#009acd"],
                            ["2x decrease", "#74b0d1"],
                            ["1.4x decrease", "#abc8d9"],
                            ["Near normal", "#dedede"],
                            ["1.4x increase", "#f8ab95"],
                            ["2x increase", "#ff7451"],
                            ["2.8x or greater increase", "#ff1900"],
                            ["No data", "#808080"]
                        ],
        ...
        map.on('click', function (e) {
            ...
            var coordx = e.lngLat.lng;
            var coordy = e.lngLat.lat;
            new mapboxgl.Popup()
