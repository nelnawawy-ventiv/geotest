define(["https://api.mapbox.com/mapbox-gl-js/v2.10.0/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v5.0.0/mapbox-gl-geocoder.min.js", "https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    ...
    BasicControl.prototype.initialize = function (oControlHost, fnDoneInitializing, oDataStore) {
        ...
        function myFunction4() {
            ...
            var visibility = map.getLayoutProperty('Road Census (2015-2020)', 'visibility');

            if (visibility === 'visible') {
                map.setLayoutProperty('Road Census (2015-2020)', 'visibility', 'none');
                //document.getElementById("v66_ValueComboBox").style.backgroundColor = '#9BA3A5';

            } else {

                map.setLayoutProperty('Road Census (2015-2020)', 'visibility', 'visible');
        ...
        function myFunction9() {
            ...
            var visibility = map.getLayoutProperty('Snowfall (2015 - 2100)', 'visibility');

            if (visibility === 'visible') {
                map.setLayoutProperty('Snowfall (2015 - 2100)', 'visibility', 'none');
                //document.getElementById("v126_ValueComboBox").style.backgroundColor = '#9BA3A5';

            } else {

                map.setLayoutProperty('Snowfall (2015 - 2100)', 'visibility', 'visible');
                //document.getElementById("v126_ValueComboBox").style.backgroundColor = '#EFE013';
            }

        }

        document.getElementById("v138_ValueComboBox").addEventListener("change", sealevelfunction);
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('load', function () {
            map.addLayer({
                "id": "Road Census (2015-2020)",
                "type": "raster",
                "minzoom": 0,
                "maxzoom": 22,
                "source": {
                    "type": "raster",
                    "tiles": ['https://gis.unece.org/server/rest/services/Transport/Road_Census/MapServer/export?dpi=96&transparent=true&format=png32&layers=show%3A0,69&bbox={bbox-epsg-3857}&bboxSR=EPSG:3857&imageSR=EPSG:3857&size=256,256&f=image'],
                ...
                }, 'layout': { 'visibility': euroroad2020 },
            });
        ...
        map.on('load', function () {
            ...
            map.addLayer({
                ...
                "paint": {
                    ...
                    "circle-opacity": 0.7,
                    'circle-stroke-width': 2,
                    'circle-stroke-color': '#6EE4FF'//'#ffffff'
                },
    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            euroroad2020 = oDataStore.getCellValue(iRow, 7)
            ...
            snowfall126 = oDataStore.getCellValue(iRow, 11)
