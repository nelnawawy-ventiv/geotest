    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('click', 'Water Stress 2030', function (e) {
            ...
            var popup = new mapboxgl.Popup({ offset: [0, -15] })
                ...
                .setHTML('<h3>' + 'Basin ID: ' + feature.properties.BasinID + '</h3><p>' + '<br>' + 'Stress Level: ' + feature.properties.ws3028cl + '<br>' + 'Description: ' + feature.properties.ws3028tl + '<br>' + 'Area (km): ' + feature.properties.Ara_km2 + '<br>' + '</p>')
