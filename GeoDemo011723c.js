...
*/
        ...
        map.on('click', function (e) {
            ...
            var feature = features[0];
            var propvalue = int(feature.properties.Value);
            var url = 'http://www.ventivtech.com'
            var popup = new mapboxgl.Popup({ offset: [0, -15] })
                .setLngLat(feature.geometry.coordinates)
                .setHTML('<h3>' + feature.properties.Office + '</h3>' + 'Street: ' + feature.properties.Street + '<br>' + 'Insured Value: ' + propvalue.toLocaleString('en-US', { style: 'currency', currency: 'EUR' }) + '</p>')
                .setLngLat(feature.geometry.coordinates)
