define(["https://api.mapbox.com/mapbox-gl-js/v2.15.0/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v5.0.0/mapbox-gl-geocoder.min.js", "https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7h.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    ...
    BasicControl.prototype.initialize = function (oControlHost, fnDoneInitializing, oDataStore) {
        ...
        document.getElementById("v203_ValueComboBox").addEventListener("change", myFunctionILLD);

        function myFunctionILLD() {
        ...
        document.getElementById("v214_ValueComboBox").addEventListener("change", myFunctionRADAR);
        ...
        document.getElementById("v225_ValueComboBox").addEventListener("change", myFunctionGLTemp);
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('load', function () {
            ...
            map.addSource('IlocosNorte-Landslide-buyovy', {
                type: 'vector',
                url: 'mapbox://nevnd.3jrplv9f' //nevnd.ckr0tdn0u4rov20to1aq9z17x-5p275' //fxhawk.cjhhzt5rk00hw2xro80s4lgdy-8ybmv'
            });
            map.addLayer({
                'id': 'Ilocos Norte Landslide Hazard',
                "type": "fill",
                "source": "IlocosNorte-Landslide-buyovy",
                "source-layer": "IlocosNorte-Landslide-buyovy",
                "layout": {
                    "visibility": ilnorteldslide
                },
                "paint": {
                    "fill-color": "#cc5008",
                    "fill-opacity": 0.6
        ...
        document.getElementById('slider').addEventListener('input', function (e) {
            ...
            map.setFilter('Earthquake - Historical', ['all', filterYear]);
    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            feature['properties'] = { 'name': oDataStore.getCellValue(iRow, 0), 'total_paid3': oDataStore.getCellValue(iRow, 25), 'Net_Incurred_Total': oDataStore.getCellValue(iRow, 26) }
            ...
            globaltemp = oDataStore.getCellValue(iRow, 22)
            tsunami = oDataStore.getCellValue(iRow, 23)
            globalradar = oDataStore.getCellValue(iRow, 24)
        ...
        map.on('click', 'points', function (e) {
            ...
            new mapboxgl.Popup()
                ...
                .setHTML('<h3>' + 'Claim: ' + Claim_N + '</h3>' + '<p>' + 'Total Net Incurred: ' + e.features[0].properties.Net_Incurred_Total.toLocaleString('en-US', { style: 'currency', currency: 'USD', }) + '<br>' + 'Paid: ' + Paid.toLocaleString('en-US', {
                    style: 'currency',
                    currency: 'USD',
