define(["https://api.mapbox.com/mapbox-gl-js/v2.15.0/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v5.0.0/mapbox-gl-geocoder.min.js", "https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7h.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    ...
    BasicControl.prototype.initialize = function (oControlHost, fnDoneInitializing, oDataStore) {
        ...
        document.getElementById("v138_ValueComboBox").addEventListener("change", myFunctionGOES);

        function myFunctionGOES() {
        ...
        document.getElementById("v160_ValueComboBox").addEventListener("change", myFunctionEUFL);
        ...
        document.getElementById("v193_ValueComboBox").addEventListener("change", myFunCtionGLRADAR);
        ...
        document.getElementById("v204_ValueComboBox").addEventListener("change", myFunctionGLTemp);

        function myFunctionGLTemp() {

            var visibility = map.getLayoutProperty('Global Temperatures', 'visibility');

            if (visibility === 'visible') {
                map.setLayoutProperty('Global Temperatures', 'visibility', 'none');
                //document.getElementById("v138_ValueComboBox").style.backgroundColor = '#9BA3A5';

            } else {

                map.setLayoutProperty('Global Temperatures', 'visibility', 'visible');
                //document.getElementById("v138_ValueComboBox").style.backgroundColor = '#EFE013';
            }

        }

        document.getElementById("v215_ValueComboBox").addEventListener("change", myFunctionTSUNAMI);
        ...
        document.getElementById("v226_ValueComboBox").addEventListener("change", myFunctionVOL);
        ...
        map = new mapboxgl.Map({
            ...
            center: [47.787075, 10.266602], //Center Map
    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            feature['properties'] = { 'name': oDataStore.getCellValue(iRow, 0), 'total_paid3': oDataStore.getCellValue(iRow, 23) }
            ...
            heatstress_eu = oDataStore.getCellValue(iRow, 15)
            flooding_eu = oDataStore.getCellValue(iRow, 16)
            civilunrest = oDataStore.getCellValue(iRow, 17)
            MODIS = oDataStore.getCellValue(iRow, 18)
            globalradar = oDataStore.getCellValue(iRow, 19)
            tsunami = oDataStore.getCellValue(iRow, 20)
            globaltemp = oDataStore.getCellValue(iRow, 21)
