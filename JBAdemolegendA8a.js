define(["https://api.mapbox.com/mapbox-gl-js/v2.3.1/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v4.7.0/mapbox-gl-geocoder.min.js", "https://unpkg.com/@turf/turf@6/turf.min.js"/*"https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js"*/, "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7c.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    "use strict";
    var map = '',
        bounds = '',
        geojsonFeature = {};
    ...
    BasicControl.prototype.initialize = function (oControlHost, fnDoneInitializing, oDataStore) {
        ...
        document.getElementById("v_ValueComboBox").addEventListener("change", myFunctionPolitical);

        function myFunctionPolitical() {

            var visibility = map.getLayoutProperty('Political', 'visibility');

            if (visibility === 'visible') {
                map.setLayoutProperty('Political', 'visibility', 'none');
                //document.getElementById("v138_ValueComboBox").style.backgroundColor = '#9BA3A5';

            } else {

                map.setLayoutProperty('Political', 'visibility', 'visible');
                //document.getElementById("v138_ValueComboBox").style.backgroundColor = '#EFE013';
            }
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        */
        map.on('load', function () {
            ...
            map.addSource('clafluvialdepthq20-5ierhr', { //'CASTSU1500B-9alk2o', {
                type: 'vector',
                url: 'nevnd.cs71cw7n', //'mapbox://nevnd.dm23d4er',
                //tileSize: 256
            });
            map.addLayer({
                "id": "clafluvialdepthq20-5ierhr",
                "type": "fill",
        ...
        map.on('load', function () {
            ...
            map.addSource('clafluvialdepthq200-961znu', { //'CASTSU1500B-9alk2o', {
                type: 'vector',
                url: 'nevnd.dnx94jmm', //'mapbox://nevnd.dm23d4er',
                //tileSize: 256
            });
            map.addLayer({
                "id": "clafluvialdepthq200-961znu",
                "type": "fill",
                "source": "clafluvialdepthq200-961znu", //"CASTSU1500B-9alk2o",
                "source-layer": "clafluvialdepthq200-961znu",//"CASTSU1500B-9alk2o",
                "minzoom": 12,
                "maxzoom": 22,
                "layout": {
                    "visibility": flooding_r
        ...
        map.addSource('clafluvialdepthq1500-3q82re', { //'CASTSU1500B-9alk2o', {
            type: 'vector',
            url: 'mapbox://nevnd.1gwnvigk', //'mapbox://nevnd.dm23d4er',
            //tileSize: 256
        });
        map.addLayer({
            "id": "clafluvialdepthq1500-3q82re",
            "type": "fill",
            "source": "clafluvialdepthq1500-3q82re", //"CASTSU1500B-9alk2o",
        ...
        map.on('load', function () {
            ...
            map.addSource('UCDPGEDEvent2106', { //'CASTSU1500B-9alk2o', {
                type: 'vector',
                url: 'mapbox://nevnd.ckshs6qu422od27qppqbmznnf-8kmoa', //'mapbox://nevnd.dm23d4er',
                //tileSize: 256
            });
            map.addLayer({
                "id": "Political",
                "type": "circle",
                "source": "UCDPGEDEvent2106", //"CASTSU1500B-9alk2o",
                "source-layer": "UCDPGEDEvent2106",//"CASTSU1500B-9alk2o",
                //"minzoom": 12,
                //"maxzoom": 22,
                "layout": {
                    "visibility": political_ur
                },
                "paint": {
                    'circle-radius': {
                        'base': 7,
