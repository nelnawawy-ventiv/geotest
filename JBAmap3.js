        ...
        map.on('load', function () {
            ...
            map.on('load', function () {
                ...
                map.addSource('Flooding-Zones', {
                    'type': 'raster',
                    'tiles': [
                        'https://coast.noaa.gov/arcgis/services/FloodExposureMapper/CFEM_FEMAFloodZones/MapServer/WMSServer?request=GetCapabilities&service=WMS'
                    ],
                    'tilesize': 256
                });
                map.addLayer({
