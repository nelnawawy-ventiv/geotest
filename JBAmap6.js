        ...
        map.on('load', function () {
            ...
            map.addLayer({
                ...
                'source': {
                    'type': 'raster',
                    'tiles': [
                        'https://coast.noaa.gov/arcgis/services/FloodExposureMapper/CFEM_FEMAFloodZones/MapServer/WmsServer?service=WMS&request=GetMap&version=1.3.0&layers=0&styles=&format=image/png&transparent=true&height=256&width=256&crs=EPSG:3857&bbox={bbox-epsg-3857}&time=' + timeBlock
                    ],
                    'tileSize': 256  
                },
                'layout': { 'visibility': flooding_r },
