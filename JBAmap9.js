        ...
        map.on('load', function () {
            ...
            /*for (var i = 0; i < frameCount; i++) {
                ...
                /*map.addSource('Flooding-Zones', {
                    'type': 'raster',
                    'tiles': [
                        'https://coast.noaa.gov/arcgis/services/FloodExposureMapper/CFEM_FEMAFloodZones/MapServer/export?dpi=96&transparent=true&format=png32&bbox={bbox-epsg-3857}&bboxSR=EPSG:3857&imageSR=EPSG:3857&size=256,256&f=image'
