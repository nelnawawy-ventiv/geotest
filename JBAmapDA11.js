define(["https://api.tiles.mapbox.com/mapbox-gl-js/v2.3.0/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v2.2.0/mapbox-gl-geocoder.min.js", "https://api.tiles.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.2.2/mapbox-gl-draw.js", "https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.2.1.min.js", "https://code.jquery.com/ui/1.12.1/jquery-ui.min.js", "text! https://cdn.jsdelivr.net/gh/Xdev9/Geospatial/Mapbox_12.css"/*, "https://raw.githubusercontent.com/watergis/mapbox-gl-legend/master/docs/bundle.js"*//*"https://www.mapbox.com/mapbox.js/api/v3.1.1/l-mapbox-legendcontrol/"*/], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info, /*MapboxLegendControl*/) {
    "use strict";
    var map = '',
        bounds = '',
        geojsonFeature = {};
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        // add legend
        var legend = new mapboxgl.LegendControl();
        map.addControl(legend, 'bottom-left');
        //map.addCotnrol(new MapboxLegendControl({}, { reverseOrder: false }), 'bottom-left');
