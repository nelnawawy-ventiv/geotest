define(["https://api.tiles.mapbox.com/mapbox-gl-js/v2.3.0/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v2.2.0/mapbox-gl-geocoder.min.js", "https://api.tiles.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.aspnetcdn.com/ajax/jQuery/jquery-3.2.1.min.js", "https://code.jquery.com/ui/1.12.1/jquery-ui.min.js", "text! https://cdn.jsdelivr.net/gh/Xdev9/Geospatial/Mapbox_12.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    ...
    BasicControl.prototype.initialize = function (oControlHost, fnDoneInitializing, oDataStore) {
        ...
        jQuery("body").prepend("<link rel='stylesheet' href='https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3/mapbox-gl-draw.css' type='text/css'/>");
    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            claim_count = oDataStore.getCellValue(iRow, 18)
        ...
        map.on('click', 'points', function (e) {
            ...
            var claimcount = e.features[0].properties.claim_count;
            ...
            new mapboxgl.Popup()
                ...
                .setHTML('<h3>' + 'Property: ' + Claim_N + '</h3>' + 'Street: ' + Street_N + '<br>' + 'City: ' + City_N + '<br>' + 'Total Insured: $ ' + paidf + '<br>' + ' Claim Count: ' + claimcount + '</p>')
                .addTo(map);
        });
