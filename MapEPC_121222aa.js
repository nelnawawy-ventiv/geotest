    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        map.on('click', 'Properties2', function (e) {
            ...
            new mapboxgl.Popup()
                ...
                .setHTML('<h3>' + 'Property: ' + e.features[0].properties.Store_Name + '</h3>' + 'Street: ' + e.features[0].properties.Store_Address + '<br>' + 'City: ' + e.features[0].properties.Store_City + '<br>' + '</p>')
                .addTo(map);
        });
