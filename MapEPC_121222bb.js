define(["https://api.mapbox.com/mapbox-gl-js/v2.11.0/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v5.0.0/mapbox-gl-geocoder.min.js", "https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7h.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, slider1, slider2, Info) {
    "use strict";
    var map = '',
        bounds = '',
        geojsonFeature = {};
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        jQuery('body .mapboxgl-control-container').append('<div id=' + 'console' + '>' + '<div>' + '<div class=' + 'session' + ' ' + 'id=' + 'sliderbar' + ' ' + '>' + ' ' + '<p>' + '<font color=' + "black" + '>' + 'Historical - Year: ' + '<label id=' + 'active-Year' + '>' + '2019' + '</label>' + '</font>' +
        ...
        */
        ...
        map.on('load', function () {
            map.addSource('EPICLOC111622-966mug', {
                type: 'vector',
                url: 'mapbox://nevnd.9b9qtt53'
            });
            map.addLayer({
                'id': 'Properties2',
                'type': 'circle',
                'source': 'EPICLOC111622-966mug',
                'source-layer': 'EPICLOC111622-966mug',
                "layout": {
                    "visibility": property,
                },
                "paint": {
    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            feature['properties'] = { 'name': oDataStore.getCellValue(iRow, 0), 'total_paid3': oDataStore.getCellValue(iRow, 22), 'street': oDataStore.getCellValue(iRow, 15), 'city': oDataStore.getCellValue(iRow, 16) }
        ...
        map.on('click', 'Properties2', function (e) {
            ...
            new mapboxgl.Popup()
                ...
                .setHTML('<h3>' + 'Property: ' + e.features[0].properties.Store_Name + '</h3>' + 'Street: ' + e.features[0].properties.Store_Address + '<br>' + 'City: ' + e.features[0].properties.Store_City + '<br>' + '<br>' + 'Location Type: ' + e.features[0].properties.Location_Division_Type + '</p>')
                .addTo(map);
        });
