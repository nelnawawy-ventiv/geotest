    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        map.on('click', 'points', function (e) {
            ...
            new mapboxgl.Popup()
                ...
                .setHTML('<h3>' + 'Claim: ' + Claim_N + '</h3>' + 'Cause: ' + cause + '<br>' + 'Customer: ' + customer + '<br>' + 'Developed Claim Cost ($): ' + paidf + '<br>' + 'Total Paid: ' + totalpaid + '<br>' + '<a href=' + hyperlink/*e.features[0].properties.RECORD_LINK.value*/ + ' target="_blank">' + 'View Details' + '</a>' + '</p>')
                .addTo(map);
        });
