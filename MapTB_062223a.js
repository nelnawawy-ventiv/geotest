define(["https://api.mapbox.com/mapbox-gl-js/v2.15.0/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v5.0.0/mapbox-gl-geocoder.min.js", "https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7h.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    ...
    BasicControl.prototype.draw = function (oControlHost) {
            ...
            for (var i = 0; i < frameCount; i++) {
                ...
                map.addLayer({
                    ...
                    'source': {
                        'type': 'raster',
                        tiles: [
							'https://maps1.aerisapi.com/mA09d6UbckvIzJgLCWzs7_FuG4M8lYxoOJUTvtvyMy2c5hhpSdmE9L89KyBSGU/lightning-all/{z}/{x}/{y}/current.png',
							'https://maps2.aerisapi.com/mA09d6UbckvIzJgLCWzs7_FuG4M8lYxoOJUTvtvyMy2c5hhpSdmE9L89KyBSGU/lightning-all/{z}/{x}/{y}/current.png',
							'https://maps3.aerisapi.com/mA09d6UbckvIzJgLCWzs7_FuG4M8lYxoOJUTvtvyMy2c5hhpSdmE9L89KyBSGU/lightning-all/{z}/{x}/{y}/current.png',
							'https://maps4.aerisapi.com/mA09d6UbckvIzJgLCWzs7_FuG4M8lYxoOJUTvtvyMy2c5hhpSdmE9L89KyBSGU/lightning-all/{z}/{x}/{y}/current.png'
						],
						tileSize: 256,
						attribution: '<a href="https://www.aerisweather.com/">AerisWeather</a>'
                    },
        ...
        map.on('load', function () {
            map.addSource('TrueBlueOrgs0223', {
                type: 'vector',
                url: 'mapbox://nevnd.cldmec07v02e420mjknsl7221-96fn2'
            });
            map.addLayer({
                'id': 'Properties2',
                'type': 'circle',
                'source': 'TrueBlueOrgs0223',
                'source-layer': 'TrueBlueOrgs0223',
                "layout": {
                    "visibility": property
                },
                "paint": {
        ...
        map.on('click', function (e) {
            ...
            var popup = new mapboxgl.Popup({ offset: [0, -15] })
                .setLngLat(feature.geometry.coordinates)
                .setHTML('<h3>' + feature.properties.Org + '</h3>' + '<p>' + 'Address: ' + feature.properties.Address_1 + '<br>' + 'City:' + feature.properties.City + '<br>' + 'State: ' + feature.properties.State + '<br>' + 'Service Line: ' + feature.properties.L3ServiceLine + '</p>')
                .setLngLat(feature.geometry.coordinates)
    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            feature['properties'] = {
                'name': oDataStore.getCellValue(iRow, 0), 'total_paid3': oDataStore.getCellValue(iRow, 25), 'cause': oDataStore.getCellValue(iRow, 19), 'customer': customer = oDataStore.getCellValue(iRow, 20), 'record_link': oDataStore.getCellValue(iRow, 21), 'Level_3': oDataStore.getCellValue(iRow, 22), 'ClaimGSCircleColor': oDataStore.getCellValue(iRow, 23), 'Total_Paid': oDataStore.getCellValue(iRow, 24) }
        ...
        map.on('click', 'points', function (e) {
            ...
            var totalpaid = e.features[0].properties.Total_Paid;
            ...
            new mapboxgl.Popup()
                ...
                .setHTML('<h3>' + 'Claim: ' + Claim_N + '</h3>' + 'Cause: ' + cause + '<br>' + 'Customer: ' + customer + '<br>' + 'Developed Claim Cost ($): ' + paidf + '<br>' + 'Total Paid: ' + totalpaid.toLocaleString("en-US", { style: "currency", currency: "USD" }) + '<br>' + '<a href=' + hyperlink/*e.features[0].properties.RECORD_LINK.value*/ + ' target="_blank">' + 'View Details' + '</a>' + '</p>')
                .addTo(map);
        });
