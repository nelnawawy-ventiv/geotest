    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        map.on('click', 'points', function (e) {
            ...
            new mapboxgl.Popup()
                ...
                .setHTML('<h3>' + 'Claim: ' + Claim_N + '</h3>' + 'Cause: ' + cause + '<br>' + 'Customer: ' + customer + '<br>' + 'Total Paid: ' + paidf + '<br>' + 'Claims TYTD: ' + total_claims + '<br>' + '<a href=' + record_link/*e.features[0].properties.RECORD_LINK.value*/ + '>' + '<target="_blank" >' + 'View Details' + '</>' + '</p>')
                .addTo(map);
        });
