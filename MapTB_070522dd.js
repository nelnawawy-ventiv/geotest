define(["https://api.mapbox.com/mapbox-gl-js/v2.8.2/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v5.0.0/mapbox-gl-geocoder.min.js", "https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    ...
    var cause = 'none';
    var customer = 'none';
    var record_link = 'none';

    function BasicControl() { };

    BasicControl.prototype.initialize = function (oControlHost, fnDoneInitializing, oDataStore) {

        document.getElementById("v114_ValueComboBox").addEventListener("change", myFunction);
        ...
        document.getElementById("v126_ValueComboBox").addEventListener("change", myFunction2);
        ...
        document.getElementById("v138_ValueComboBox").addEventListener("change", myFunction3);
        ...
        document.getElementById("v150_ValueComboBox").addEventListener("change", myFunction4);
        ...
        document.getElementById("v162_ValueComboBox").addEventListener("change", myFunction5);
        ...
        document.getElementById("v174_ValueComboBox").addEventListener("change", myFunction6);
        ...
        document.getElementById("v186_ValueComboBox").addEventListener("change", myFunction7);
        ...
        document.getElementById("v198_ValueComboBox").addEventListener("change", myFunction8);
        ...
        document.getElementById("v210_ValueComboBox").addEventListener("change", myFunction9);
        ...
        document.getElementById("v222_ValueComboBox").addEventListener("change", tornadoes24);
        ...
        document.getElementById("v234_ValueComboBox").addEventListener("change", myFunction10);
        ...
        document.getElementById("v246_ValueComboBox").addEventListener("change", myFunction11);
        ...
        document.getElementById("v258_ValueComboBox").addEventListener("change", myFunction12);
    ...
    BasicControl.prototype.setData = function (oControlHost, oDataStore) {
        ...
        for (var iRow = 0; iRow < iRowCount; iRow++) {
            ...
            cause = oDataStore.getCellValue(iRow, 18)
            customer = oDataStore.getCellValue(iRow, 19)
            record_link = oDataStore.getCellValue(iRow, 20)
        ...
        map.on('click', 'points', function (e) {
            ...
            var hyperlink = e.features[0].properties.hyperlink;

            var causee = e.features[0].properties.general_cause;

            var customerr = e.features[0].properties.customer;
            ...
            new mapboxgl.Popup()
                ...
                .setHTML('<h3>' + 'Claim: ' + Claim_N + '</h3>' + 'Cause: ' + cause + '<br>' + 'Customer: ' + customer + '<br>' + 'Total Paid: ' + paidf + '<br>' + 'Claims TYTD: ' + total_claims + '<br>' + '<a href=' + record_link + ' target="_blank">' + 'View Details' + '</a>' + '</p>')
                .addTo(map);
        });
