                ...
                for (var i = 0; i < frameCount; i++) {
                    ...
                    map.addLayer({
                        ...
                        'source': {
                            'type': 'raster',
                            'tiles': [
                                'https://idpgis.ncep.noaa.gov/arcgis/rest/services/NWS_Forecasts_Guidance_Warnings/NDFD_temp/MapServer/export?dpi=96&bbox=-293.7692491671929,-328.4203216326983,80.39101937471492,439.0178934058135&layers=show:127&transparent=true&format=png32&bboxSR=EPSG:4269&imageSR=EPSG:4269&size=256,256&f=image'
                            ],
                            'tileSize': 256
                        },
