define(["https://api.mapbox.com/mapbox-gl-js/v2.7.0/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v4.7.2/mapbox-gl-geocoder.min.js", "https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('click', 'US Weather Alerts', function (e) {
            ...
            var popup = new mapboxgl.Popup({ offset: [0, -15] })
                .setLngLat(e.lngLat)
                .setHTML('<h3>' + e.features[0].properties.HEADLINE + '</h3><p>' + '<br>' + 'Effective: ' + e.features[0].properties.EFFECTIVE + '<br>' + 'Expires: ' + e.features[0].properties.EXPIRES + '<br>' + ' Event Type: ' + e.features[0].properties.EVENT + '<br>' + ' Severity: ' + e.features[0].properties.SEVERITY + '<br>' + ' Status: ' + e.features[0].properties.SEVERITY + '</p>')
                //.setLngLat(feature.geometry.coordinates)
                .addTo(map);
