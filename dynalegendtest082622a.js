define(["https://api.mapbox.com/mapbox-gl-js/v2.9.2/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v5.0.0/mapbox-gl-geocoder.min.js", "https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info) {
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        map.on('load', function () {
            ...
            var legendresponse = "https://coast.noaa.gov/arcgis/rest/services/FloodExposureMapper/CFEM_CoastalFloodHazardComposite/MapServer/legend?dynamicLayers=%5B%7B%22id%22%3A0%2C+%22source%22%3A%7B%22type%22%3A%22mapLayer%22%2C+%22maplayerId%22%3A0%7D%7D%5D&f=html"; //"https://coast.noaa.gov/arcgis/rest/services/FloodExposureMapper/CFEM_CoastalFloodHazardComposite/MapServer/legend?dynamicLayers=%5B0%5D&f=pjson"
            //document.getElementById('mydiv').innerHTML = "<p>some html</p>"
            jQuery('body .mapboxgl-control-container').append(legendresponse); //.append('<div id=' + 'main-legend' + ' ' + 'class=' + 'legend' + '>')
        });

        map.on('mouseenter', 'US Flood Zones', () => {
            map.getCanvas().style.cursor = 'pointer';
        });

        map.on('mouseleave', 'US Flood Zones', () => {
            map.getCanvas().style.cursor = 'pointer';
        });
        ...
        map.on('click', function (e) {
            ...
            var features = map.queryRenderedFeatures(e.point, {
                layers: ['US Flood Zones'] // replace this with the name of the layer
            });
