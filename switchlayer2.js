define(["https://api.mapbox.com/mapbox-gl-js/v2.3.1/mapbox-gl.js", "jquery", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-geocoder/v4.7.0/mapbox-gl-geocoder.min.js", "https://unpkg.com/@turf/turf@6/turf.min.js"/*"https://api.mapbox.com/mapbox.js/plugins/turf/v3.0.11/turf.min.js"*/, "https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/mapbox-styleswitch/index.js", "https://api.mapbox.com/mapbox-gl-js/plugins/mapbox-gl-draw/v1.3.0/mapbox-gl-draw.js", "https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js",/*"https://code.jquery.com/ui/1.12.1/jquery-ui.min.js",*/ "text! https://cdn.jsdelivr.net/gh/nelnawawy-ventiv/geotest/Demobase7.css"], function (mapboxgl, jQuery, MapboxGeocoder, turf, MapboxDraw, slider1, slider2, Info, StyleSwitcherControl) {
    "use strict";
    var map = '',
        bounds = '',
        geojsonFeature = {};
    ...
    function StyleSwitcherControl() {
        import 'https://cdn.jsdelivr.net/gh/wabson/mapbox-gl-style-switcher/src/style.css';
        const DEFAULT_CONTROL_POSITION = 'top-left';
    ...
    BasicControl.prototype.draw = function (oControlHost) {
        ...
        var layerSwitch = new StyleSwitcherControl({            
            styles: [
                {
                    uri: 'mapbox://styles/mapbox/streets-v11',
                    title: 'Streets',
        ...
        //map.addControl(layerSwitch, 'top-left');
        map.on('load', function (e) { map.addControl(layerSwitch, 'top-left')});
